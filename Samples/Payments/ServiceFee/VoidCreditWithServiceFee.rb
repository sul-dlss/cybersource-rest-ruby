...
require_relative './ProcessCreditWithServiceFee.rb'
...
public
class VoidCreditWithServiceFee
  def main
    ...
    response = ProcessCreditWithServiceFee.new.main
  ...
  if __FILE__ == $0
    VoidCreditWithServiceFee.new.main
  end
end
